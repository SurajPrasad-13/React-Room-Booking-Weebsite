...
//     setBookingStatuses((prev) => ({ ...prev, [id]: "checked-in" }));
//   };
...
//   return (
//     <div className="bg-white m-10 p-3 rounded-xl">
//       <div className="flex items-center justify-between">
//         <h1 className="text-2xl font-semibold">Recent Bookings</h1>
//         <input
//           className="border border-gray-200 p-2 px-4 rounded-lg"
//           type="text"
...
//         const status = bookingStatuses[item.bookingId] || "initial";

//         return (
//           <div
//             key={item.bookingId}
//             className="rounded-lg border border-gray-200 flex px-3 items-center justify-between hover:shadow-lg text-gray-600 my-5"
//           >
...
//                   className="border rounded-lg p-1 px-3 border-gray-400 text-black hover:bg-blue-100"
//                 >
//                   Check Out
//                 </button>
//               ) : (
...
//               <button className="border text-black rounded-lg p-1 px-3 border-gray-400 hover:bg-blue-100 flex justify-center items-center gap-2">
